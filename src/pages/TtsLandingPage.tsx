      ...
      <Paper sx={paperSx}>
        <Stack direction="column" alignItems="center" spacing={3}>
          ...
          <Typography variant="body1" className="text-text-secondary mb-4 max-w-xl">
            Generate high-quality, natural-sounding speech from your text inputs. Configure multiple
            speakers with unique voice profiles and languages. Ideal for creating dialogue, audio
            content, or accessibility features.
          </Typography>
          <Typography variant="body2" className="text-text-secondary mb-6">
            This tool leverages Google Gemini's advanced Text-to-Speech capabilities, offering a
            wide range of voices and precise control over speech synthesis.
          </Typography>
          <Button
